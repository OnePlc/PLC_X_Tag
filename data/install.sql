...
('tag-merge', 'Merge Tags', 'OnePlace\\Tag\\Model\\Tag', 'OnePlace\\Tag\\Model\\TagTable');
...
(NULL, 'Merge Tags', 'fas fa-save', 'Merge Tags', '#', 'primary saveForm', '', 'tag-merge', 'link', '', ''),
...
('tag-mergebase', 'tag-merge', 'Merge Tags', 'Select Tags', 'fas fa-tags', '', '0', '', ''),
