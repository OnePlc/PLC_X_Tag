<?php
/**
 * TagControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Tag Module
 *
 * @category Test
 * @package Tag
...
namespace OnePlaceTest\Tag\Controller;

use OnePlace\Tag\Controller\TagController;
...
class TagControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/tag', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('tag');
        $this->assertControllerName(TagController::class); // as specified in router's controller name alias
